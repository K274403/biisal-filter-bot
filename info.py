...
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/GoQ.jpg')
START_IMG = environ.get('START_IMG', 'https://envs.sh/rDg.jpg')
...
STICKERS_IDS = ('CAACAgUAAxkBAAID0Gd09g-hHQtczyVyOjkIfdCAytNyAAIJFwACiuGoVzBJhEjGlpeqHgQ').split()
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002432444111')
